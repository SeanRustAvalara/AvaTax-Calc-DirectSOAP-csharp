    ...
    public class GetTaxTest
    {
        public static void Test()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Result: {0}", getTaxResult.ResultCode.ToString());
                ...
                else
                {
                    ...
                    if (getTaxRequest.DetailLevel == DetailLevel.Diagnostic)
                    {
                        foreach (Message message in getTaxResult.Messages)
                        {
                            Console.WriteLine("{0}\n{1}\n{2}", 
            ...
            Console.WriteLine("End GetTaxTest. Press enter to continue.");
            Console.ReadLine();
        }
    }
}
